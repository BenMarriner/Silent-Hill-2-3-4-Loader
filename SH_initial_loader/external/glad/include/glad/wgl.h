 ...
 *
 * Commandline:
 *    --api='wgl=1.0' --extensions='WGL_ARB_extensions_string,WGL_ARB_pbuffer,WGL_ARB_pixel_format,WGL_ARB_pixel_format_float,WGL_ARB_render_texture,WGL_EXT_extensions_string,WGL_EXT_swap_control' c --alias --debug
 *
 * Online:
 *    http://glad.sh/#api=wgl%3D1.0&extensions=WGL_ARB_extensions_string%2CWGL_ARB_pbuffer%2CWGL_ARB_pixel_format%2CWGL_ARB_pixel_format_float%2CWGL_ARB_render_texture%2CWGL_EXT_extensions_string%2CWGL_EXT_swap_control&generator=c&options=ALIAS%2CDEBUG
 *
 */
